...
def process_instruction(grid: DefaultDict[Coord, Dict], thread_id: int, curpos: Coord, steps: int, instruction: Instruction) -> Coord:
...
if __name__ == '__main__':
    ...
    intersections = [key for (key, value) in filled_grid.items() if len(filled_grid[key]) == 2]
